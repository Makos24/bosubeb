        ...
        foreach ($rows as $row) 
        {
            ...
            $staff = Staff::firstOrCreate(
                ...
                [
                    ...
                    'duty_station' => $row['duty_station_lga'] != "" ? DutyStation::firstOrCreate(['name' => $row['duty_station_lga'], 'lga_id' => $lga_id])->id : null, 
                    'minimum_wage' => isset($row['minimum_wage']) ? $row['minimum_wage'] : null, 
                    ...
                    'phone' => $row['phone_no'],  
                    'nin' => $row['nin_no'],  
                    'lga_of_origin_id' => LGA::where('name', ucwords(strtolower($row['lga_of_origin'])))->first() ? LGA::where('name', ucwords(strtolower($row['lga_of_origin'])))->first()->id : null,  
                    ...
                    'cadre' => $row['cadrerank'] != "" ? Cadre::firstOrCreate(['name' => $row['cadrerank']])->id : null,  
                    //'salary_id' => 1,  
