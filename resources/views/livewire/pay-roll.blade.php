...
<table border="1" class="fi-ta-table w-full table-auto divide-y divide-gray-200 text-start dark:divide-white/5">
    ...
    @foreach($payrolls as $payroll)
        ...
        <tr>
            ...
            <td class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3 fi-table-cell-transport"><div class="fi-ta-col-wrp"><div class="fi-ta-text grid gap-y-1 px-3 py-4">{{ $b = number_format($payroll->sum('salary_basic')) }}</div></div></td>
            <td class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3 fi-table-cell-transport"><div class="fi-ta-col-wrp"><div class="fi-ta-text grid gap-y-1 px-3 py-4">{{ $r = number_format($payroll->sum('salary_rent')) }}</div></div></td>
            <td class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3 fi-table-cell-transport"><div class="fi-ta-col-wrp"><div class="fi-ta-text grid gap-y-1 px-3 py-4">{{ $t = number_format($payroll->sum('salary_transport')) }}</div></div></td>
            <td class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3 fi-table-cell-transport"><div class="fi-ta-col-wrp"><div class="fi-ta-text grid gap-y-1 px-3 py-4">{{ $m = number_format($payroll->sum('salary_meals')) }}</div></div></td>
            <td class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3 fi-table-cell-transport"><div class="fi-ta-col-wrp"><div class="fi-ta-text grid gap-y-1 px-3 py-4">{{ $u = number_format($payroll->sum('salary_utility')) }}</div></div></td>
            <td class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3 fi-table-cell-transport"><div class="fi-ta-col-wrp"><div class="fi-ta-text grid gap-y-1 px-3 py-4">{{ $e = number_format($payroll->sum('salary_ent')) }}</div></div></td>
            <td class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3 fi-table-cell-transport"><div class="fi-ta-col-wrp"><div class="fi-ta-text grid gap-y-1 px-3 py-4">{{ $l = number_format($payroll->sum('salary_ent')) }}</div></div></td>
            <td class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3 fi-table-cell-transport"><div class="fi-ta-col-wrp"><div class="fi-ta-text grid gap-y-1 px-3 py-4">{{ $tf = number_format($payroll->where('cadre', 19)->whereBetween('qualification', [1, 10])->sum('salary_basic') * .275) }}</div></div></td>
            <td class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3 fi-table-cell-transport"><div class="fi-ta-col-wrp"><div class="fi-ta-text grid gap-y-1 px-3 py-4">{{ $ft = number_format($payroll->where('cadre', 19)->whereNotBetween('qualification', [1, 10])->sum('salary_basic') * .15) }}</div></div></td>
            <td class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3 fi-table-cell-transport"><div class="fi-ta-col-wrp"><div class="fi-ta-text grid gap-y-1 px-3 py-4">{{ $tw = number_format($payroll->where('cadre','<>', 19)->whereBetween('qualification', [1, 10])->sum('salary_basic') * .125) }}</div></div></td>
            <td class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3 fi-table-cell-transport"><div class="fi-ta-col-wrp"><div class="fi-ta-text grid gap-y-1 px-3 py-4">{{ $zr = number_format($payroll->where('cadre','<>', 19)->whereNotBetween('qualification', [1, 10])->sum('salary_basic') * 0) }}</div></div></td>
            ...
            <td class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3 fi-table-cell-transport"><div class="fi-ta-col-wrp"><div class="fi-ta-text grid gap-y-1 px-3 py-4">{{ number_format($payroll->sum('salary_paye')) }}</div></div></td>
            <td class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3 fi-table-cell-transport"><div class="fi-ta-col-wrp"><div class="fi-ta-text grid gap-y-1 px-3 py-4">{{ $nt = number_format($payroll->where('cadre', 19)->sum('salary_basic') * .03) }}</div></div></td>
            <td class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3 fi-table-cell-transport"><div class="fi-ta-col-wrp"><div class="fi-ta-text grid gap-y-1 px-3 py-4">{{ $nl = number_format($payroll->where('cadre','<>', 19)->sum('salary_basic') * .03) }}</div></div></td>
